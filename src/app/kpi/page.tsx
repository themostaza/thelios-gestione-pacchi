    ...
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="flex flex-col">
        ...
        <div className={`flex items-center text-sm ${positive ? 'text-green-600' : 'text-red-600'}`}>
          ...
          <TrendingUp size={16} className={`${!positive && 'transform rotate-180'}`} />
        </div>
      </div>
    </div>
  );
            ...
            <ResponsiveContainer width="100%" height="100%">
              {chartTypes.status === 'pie' ? (
                ...
                <BarChart data={data.statusData}>
                  ...
                  <Tooltip formatter={(value) => [`${value} pacchi`, 'Quantità']} />
                  <Legend />
                  <Bar dataKey="count" name="Pacchi" fill="#0088FE" />
                </BarChart>
              ) : (
                <LineChart data={data.statusData}>
                  ...
                  <Tooltip formatter={(value) => [`${value} pacchi`, 'Quantità']} />
                  <Legend />
                  <Line type="monotone" dataKey="count" name="Pacchi" stroke="#0088FE" />
                </LineChart>
              )}
            </ResponsiveContainer>
          </div>
            ...
            <ResponsiveContainer width="100%" height="100%">
              {chartTypes.timeline === 'bar' ? (
                <BarChart data={data.thirtyDaysData}>
                  ...
                  />
                  <Legend />
                  <Bar dataKey="count" name="Pacchi Ricevuti" fill="#0088FE" />
                </BarChart>
              ) : (
                <LineChart data={data.thirtyDaysData}>
                  ...
                  />
                  <Legend />
                  <Line type="monotone" dataKey="count" name="Pacchi Ricevuti" stroke="#0088FE" strokeWidth={2} />
                </LineChart>
              )}
            </ResponsiveContainer>
          </div>
            ...
            <ResponsiveContainer width="100%" height="100%">
              {chartTypes.avgTime === 'bar' ? (
                <BarChart data={data.averageTimeData}>
                  ...
                  <Legend />
                  <Bar dataKey="days" name="Giorni medi di giacenza" fill="#FFBB28" />
                </BarChart>
              ) : (
                <LineChart data={data.averageTimeData}>
                  ...
                  <Tooltip formatter={(value) => [`${value} giorni`, 'Tempo medio']} />
                  <Legend />
                  <Line type="monotone" dataKey="days" name="Giorni medi di giacenza" stroke="#FFBB28" strokeWidth={2} />
                </LineChart>
              )}
            </ResponsiveContainer>
          </div>
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="flex items-center">
              <div className="w-full bg-gray-200 rounded-full h-4 mr-2">
                <div className="bg-red-600 h-4 rounded-full" style={{ width: '4.3%' }}></div>
              </div>
